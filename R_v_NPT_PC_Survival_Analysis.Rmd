...
ggsave(filename = "output/resistant_kmplot.png", plot = resistant_kmplot_gg, width = 10, height = 6)
ggsave(filename = "output/npt_kmplot.png", plot = npt_kmplot_gg, width = 10, height = 6)
...
# Save the ggplot objects
ggsave(filename = "output/resistant_v_npt_kmplot.png", plot = combined_gg, width = 10, height = 6)
```
...
# Open a PDF device
pdf("output/resistant_km_plots.pdf")
